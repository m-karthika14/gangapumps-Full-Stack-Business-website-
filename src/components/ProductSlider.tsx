...
const ProductSlider: React.FC = () => {
  ...
  const repeatedProducts = [...products, ...products]; // Doubled, not tripled

  return (
    <section
      className="pb-0 sm:pb-10 w-screen bg-transparent overflow-hidden flex flex-col justify-start relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] custom-top-padding custom-bottom-padding custom-tablet-width"
      aria-labelledby="productSliderHeading"
    >
      {/* Heading */}
      <div className="text-center px-4 custom-mobile-heading-gap">
        <h2
          id="productSliderHeading"
          className="font-playfair text-3xl sm:text-4xl font-bold text-white mb-1 sm:mb-3"
        >
          Our Products
        </h2>
      ...
      {/* Scrollable Slider */}
      <div className="w-screen overflow-x-auto sm:overflow-hidden custom-slider-container" role="region" aria-label="Scrollable product showcase">
      ...
      <style>{`
        @media (max-width: 639px) {
          .custom-top-padding { padding-top: 0.375rem !important; }
          .custom-bottom-padding { padding-bottom: 0 !important; }
          .custom-mobile-heading-gap { margin-bottom: 2.36rem !important; }
          .custom-slider-container { margin-top: 0.25rem !important; margin-bottom: 0.25rem !important; }
          .custom-mobile-cta-gap { margin-top: 2rem !important; margin-bottom: 0 !important; }
          .custom-mobile-cta-gap button { margin-bottom: 0 !important; }
        }
        ...
        @media (max-width: 1023px) {
          ...
          .custom-mobile-heading-gap { margin-bottom: 2.36rem !important; }
          .custom-slider-container { margin-top: 0.25rem !important; margin-bottom: 0.25rem !important; }
          .custom-mobile-cta-gap { margin-top: 2rem !important; margin-bottom: 0.5rem !important; }
          .custom-mobile-cta-gap button { margin-bottom: 0 !important; }
        }

        @media (min-width: 1024px) {
          .custom-top-padding { padding-top: 0 !important; }
          .custom-bottom-padding { padding-bottom: 2.5rem !important; }
          .custom-mobile-heading-gap { margin-bottom: 2rem !important; }
          .custom-slider-container { margin-top: 0 !important; margin-bottom: 0 !important; }
          .custom-mobile-cta-gap { margin-top: 3rem !important; margin-bottom: 0 !important; }
        }
