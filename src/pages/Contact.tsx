  ...
  return (
    <div className="min-h-screen bg-dark pt-40 pb-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/90 rounded-3xl shadow-[0_15px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] transition-shadow duration-300 p-4 sm:p-8 mb-12">
        ...
        <div className="bg-white/90 rounded-3xl shadow-[0_15px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] transition-shadow duration-300 p-6 sm:p-8">
